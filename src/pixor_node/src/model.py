...
#only detect objects in camera field of view
...
class PIXOR(nn.Module):
	...
	def __init__(self, geom, use_bn=True, device='cuda', decode=False):
	...
	def forward(self, x):
		...
		self.cam_fov_mask = self.cam_fov_mask.to(self.device)
