...
//    sensor_msgs::CameraInfo ros_cameraInfoMsg;
    ...
    if (options.viewer)
    {
        ...
        if (options.color || options.all_data)
        {
            ...
            cv_image02 = cv::imread(full_filename_image02, -1);
            cv::waitKey(5);
        }
        if (options.grayscale || options.all_data)
        {
            ...
            cv_image00 = cv::imread(full_filename_image00, -1);
            cv::waitKey(5);
        }
        if (options.viewDisparities || options.all_data)
        {
            ...
            cv_disparities = cv::imread(full_filename_Disparities, -1);
            cv::waitKey(5);
        }
    ...
    do
    {
        ...
        if (options.stereoDisp)
        {
            ...
            cv_image04 = cv::imread(full_filename_image04, 0);
        ...
        if (options.color || options.all_data)
        {
            ...
            cv_image02 = cv::imread(full_filename_image02, -1);
            cv_image03 = cv::imread(full_filename_image03, -1);
        ...
        if (options.grayscale || options.all_data)
        {
            ...
            cv_image00 = cv::imread(full_filename_image00, -1);
            cv_image01 = cv::imread(full_filename_image01, -1);
